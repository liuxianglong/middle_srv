...
type UserClient interface {
	...
	Modify(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*CreateReq, error)
}
...
func (c *userClient) Modify(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*CreateReq, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateReq)
...
type UserServer interface {
	...
	Modify(context.Context, *CreateReq) (*CreateReq, error)
...
func (UnimplementedUserServer) Modify(context.Context, *CreateReq) (*CreateReq, error) {
...
func _User_Modify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Modify(ctx, req.(*CreateReq))
	}
	return interceptor(ctx, in, info, handler)
}
